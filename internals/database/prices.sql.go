...
func (q *Queries) GetLatestPrice(ctx context.Context, itemID int64) (GetLatestPriceRow, error) {
...
func (q *Queries) GetPricebyId(ctx context.Context, itemID int64) ([]GetPricebyIdRow, error) {
